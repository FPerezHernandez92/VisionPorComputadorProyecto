...
void SacarPielYRecortarPiel(vector<Mat> imagenes_caras, vector<Mat> &imagenes_caras_buenas,
	...
	vector<int> &col_recortadas_izquierda /*primero_col*/, vector<Mat> &imagenes_YCrCb){
	//3.1 Sacar piel
...
int main(){
	...
	vector<Mat> imagenes_recortadas, imagenes_color_recortadas, imagenes_caras_buenas, imagenes_YCrCb;
	SacarPielYRecortarPiel(imagenes_caras, imagenes_caras_buenas, imagenes_recortadas, imagenes_color_recortadas, filas_recortadas_arriba, col_recortadas_izquierda, imagenes_YCrCb);
	...
	//4. Filtro Gaussiano
	AplicarFiltroGaussiano(imagenes_YCrCb);
